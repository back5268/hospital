...
const items = [{ label: 'Đổi mật khẩu', icon: BiUserCircle, route: '/personal' }];

const AvatarSection = ({ onSignOut, mode = 'admin', setShow }) => {
        ...
        >
          <div className="flex h-24 items-center">
            ...
            <div className="w-7/12 items-center text-left">
              <h4 className="font-medium">{userInfo?.full_name}</h4>
